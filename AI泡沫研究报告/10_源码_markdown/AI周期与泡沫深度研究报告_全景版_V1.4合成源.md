...
> **数据截止**：公司公告、财报与一手研究资料滚动核验至 2026-07-24 18:53（北京时间）；A股收盘价更新至 2026-07-24，海外权益市场收盘价更新至 2026-07-23，CAPE/VIX/HY OAS 保留各自标注日期。

<!-- status-split -->

> **版本性质**：这是当前研究维护版。已投递 ZIP、其中的主报告/审计表/简历/样稿，以及已登记的前瞻判断原件全部冻结，不回写、不追溯改写。
...
> **2026-07-24 A股收盘核验**：新易盛预告后五个交易日窗口已经结束。7/24收476.02元，五日最高收盘551.77元，未恢复事前原件采用的6/23收盘锚552.00元，且较7/1阶段高点618.87元低23.1%。新易盛的盈利腿与价格腿均成立；中际旭创业绩腿仍待披露，因此E判断2整条继续记“部分验证”，总记分仍为3条成立、1条部分验证、2条待核、0条错误。

### 0. V1.4滚动更新日志（7/20—7/24）

#### V1.4·7/24收盘｜E判断2价格腿结算

**改动一：收盘结算。** 新易盛7/24收476.02元；预告后五个交易日最高收盘551.77元，未恢复6/23收盘锚552.00元，也未接近7/1阶段高点618.87元。

**改动二：验证记分卡。** 新易盛盈利腿与价格腿均成立；中际旭创尚无可核半年报预告，E判断2整条继续记“部分验证”。
...
**判断2｜光模块业绩与价格：部分验证。** 新易盛盈利腿成立；7/24收盘后价格腿也成立。中际旭创业绩腿仍待披露，按事前锁定的双样本保守规则，整条暂不升级为“成立”。
...
**当前汇总：3条成立、1条部分验证、2条待核、0条错误。** 已到期的价格腿按规则结算；仍待披露的公司样本不提前计分。
...
| 新易盛 | **476.02元** | 2026-07-24 | 预告后五日最高收盘551.77元，未恢复6/23收盘锚552.00元；E判断2的新易盛价格腿成立 |
| A股市场背景 | **上证 -1.61% / 深成指 -2.47%** | 2026-07-24 | 个股弱反应含市场共同因素；只结算事前规则结果，不作单因归因 |

**结构地基。** “高估值 + 低波动 + 窄利差”仍然成立。

**市场变化。** 7/23 GOOGL下跌和Nasdaq回撤，说明市场开始提高对CapEx与FCF错配的惩罚；7/24新易盛价格腿按事前规则结算为成立。
...
4. **A股收盘结算**：新易盛7/24收盘完成E判断2的五交易日价格观察。盈利腿与价格腿均成立，但中际旭创样本仍待披露，整条维持“部分验证”；当天市场普跌降低了个股因果归因纯度，不改变按事前规则进行的结果计分。

5. **判断与模型**：新增事实没有触发新的严格条件，也没有足够证据改变77分或A44/B22/C10/D24；保持原值比追随单日市场反应更稳健。

6. **目录治理**：主报告、审计表、简版和完整重排版均由同一Markdown源自动生成目录；超全景版的当前封面和更新正文前置，历史正文保留原目录链接，避免因插页造成目录错位。
...
11. **E验证记分卡**：判断4由待核转为成立；7/24收盘后，新易盛盈利腿和价格腿均成立，但中际旭创仍待披露，当前仍为3条成立、1条部分验证、2条待核、0条错误。

12. **监测表**：7/24价格腿完成结算；下一窗口刷新为FOMC、Microsoft、Meta、VRT和Amazon。

13. **版本治理**：已投递材料与前瞻判断原件保持冻结；V1.4是当前研究维护版。
