...
**信源边界。** 评级行动由两家二手快讯一致转述，S&P公开评级原文尚未补入；评级事件按★★使用。融资数字来自Oracle官方公告，按★★★使用。
...
#### 3.7 DeepSeek与昇腾：从“完全训练替代”修正为“首发适配＋后训练能力”
...
| NVDA | **$208.76** | 2026-07-23 | [ChartExchange历史收盘](https://chartexchange.com/symbol/nasdaq-nvda/historical/)；8/26 财报前，严格触发③仍 SAFE |
...
**市场变化。** 7/23 GOOGL下跌和Nasdaq回撤，与市场降低对高CapEx和负FCF容忍度的解释一致，但不构成单因证明；7/24新易盛价格腿按事前零容差规则结算为临界成立。
...
4. **A股收盘结算**：新易盛7/24收盘完成E判断2的五交易日价格观察。盈利腿成立，价格腿按事前零容差规则临界成立；五日最高收盘仅比锚点低0.23元（0.04%），若另设0.1%安全边际则为临界未决。中际旭创样本仍待披露，整条维持“部分验证”；当天市场普跌降低了个股因果归因纯度，不改变按事前规则进行的结果计分。
...
9. **DeepSeek口径**：补入V4官方模型信息、华为云首发适配及V4-Flash API服务、910C后训练论文；更正“完整训练替代”和无一手来源的“R2 32B”表述。

10. **事实审计表**：V1.4首发新增13i—13l，7/21新增13m—13n，7/23新增13o—13p，7/24新增13q—13r，总数由63项扩至73项；日度市场数据单列快照。

11. **E验证记分卡**：判断4由待核转为成立；7/24收盘后，新易盛盈利腿成立、价格腿规则内临界成立，但中际旭创仍待披露，当前仍为3条成立、1条部分验证、2条待核、0条错误。

12. **监测表**：7/24价格腿完成结算；下一窗口刷新为FOMC、Microsoft、Meta、VRT和Amazon。

13. **版本治理**：历史发布材料与前瞻判断原件保持冻结；V1.4是当前研究维护版。
